...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.rect = self.image.get_rect(midbottom=(int(10 * WIDTH/100), int(66 * HEIGHT/100)))
        self.gravity = 0
    ...
    def player_input(self):
        ...
        if keys[pygame.K_SPACE] and self.rect.bottom >= int(66 * HEIGHT/100):
            self.gravity = -20
    ...
    def apply_gravity(self):
        ...
        if self.rect.bottom >= int(66 * HEIGHT/100):
            self.rect.bottom = int(66 * HEIGHT/100)
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, type_enemy):
        ...
        if type_enemy == 'fly':
            ...
            y_pos = int(52 * HEIGHT/100)
        else:
            snail_1 = pygame.image.load('graphics/snail/snail1.png').convert_alpha()
            snail_2 = pygame.image.load('graphics/snail/snail2.png').convert_alpha()
            self.frames = [snail_1, snail_2]
            y_pos = int(66 * HEIGHT/100)
...
def display_score():
    ...
    score_rect = score_surf.get_rect(center=(WIDTH/2, int(10 * HEIGHT / 100)))
...
font = pygame.font.Font('font/pixeltype.ttf', int(4 * WIDTH/100))
game_active = False
start_time = 0
score = 0
...
player_stand_rect = player_stand.get_rect(center=(WIDTH/2, int(40 * HEIGHT/100)))

game_name = font.render('PIXEL RUNNER', False, (111, 196, 169))
game_name_rect = game_name.get_rect(center=(WIDTH/2, int(15 * HEIGHT / 100)))

game_message = font.render('Press "SPACE" to "START" or "ESC" to "EXIT"', False, (111, 196, 169))
game_message_rect = game_message.get_rect(center=(WIDTH/2, int(75 * HEIGHT / 100)))
...
while True:
    ...
    if game_active:
        ...
        screen.blit(ground_surface, (0, int(66 * HEIGHT / 100)))
        score = display_score()
        ...
        score_message_rect = score_message.get_rect(center=(WIDTH/2, int(75 * HEIGHT/100)))
