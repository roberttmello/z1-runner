...
while True:
    ...
    if game_active:
        ...
        score_message_surface_rectangle = score_message_surface.get_rect(center=(WIDTH, 580))
        ...
        if score == 0:
            ...
            game_message_surface_rectangle = game_message_surface.get_rect(center=(WIDTH, 660))
